...
if __name__ == '__main__':
    ...
    parser.add_argument('--process_test_data_only', action='store_true')
    ...
    if args.make_split:
        ...
        data_split = {}
        splits_to_process = ['test'] if args.process_test_data_only else ['test', 'val', 'train']
    ...
    if not args.process_test_data_only:
